  ...
  render() {
    if (this.state.author === "") {
      ...
      if (this.state.photo === "" || this.state.photo === null) {
        return (
          <div id="story_page">
            <h1 id='header_post' style={{position:"relative"}}>{this.state.title}</h1>
            <p>{this.state.text}</p>
        ...
        return (
          <div id="story_page">
            ...
            <p style={{width:'90%',position:'relative',left:'5%'}}>{this.state.text}</p>
            <div style={{position:'relative',left:'3%'}}>id: {this.state.id}</div>
            <div style={{position:'relative',left:'3%'}}>author: {this.state.author}</div>
          </div>
        );
      }
    }
